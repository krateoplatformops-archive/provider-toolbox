...
import (
	...
	"github.com/krateoplatformops/provider-toolbox/internal/controllers"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Toolbox support for Crossplane.").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-toolbox"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(ratelimiter.LimitRESTConfig(cfg, *maxReconcileRate), ctrl.Options{
		...
		LeaderElectionID:           "leader-election-provider-toolbox",
